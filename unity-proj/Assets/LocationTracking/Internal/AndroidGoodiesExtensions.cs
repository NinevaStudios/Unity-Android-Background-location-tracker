...
namespace DeadMosquito.AndroidGoodies.Internal
{
	...
	static class AndroidGoodiesExtensions
	{
		...
		[PublicAPI]
		public static string CallStrSafe(this AndroidJavaObject ajo, string methodName, params object[] args)
		{
			try
			{
				return ajo.Call<string>(methodName, args);
		...
		[PublicAPI]
		public static bool CallBoolSafe(this AndroidJavaObject ajo, string methodName, params object[] args)
		{
			try
			{
				return ajo.Call<bool>(methodName, args);
		...
		[PublicAPI]
		public static int CallIntSafe(this AndroidJavaObject ajo, string methodName, params object[] args)
		{
			try
			{
				return ajo.Call<int>(methodName, args);
